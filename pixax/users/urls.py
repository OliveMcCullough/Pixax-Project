...
from .views import FriendAdd, FriendAddDone, FriendLinkConfirm, FriendList, FriendRequestList, ProfilePicEditView, RegisterView, LoginView, ProfileView, ProfileUsernameEditView
